...
class Generator {
	...
	public function intersectFaces(f0:Face, f1:Face, f2:Face):Vector3 {
		...
		return (((f1.planeNormal % f2.planeNormal) * f0.planeDist) + ((f2.planeNormal % f0.planeNormal) * f1.planeDist)
			+ ((f0.planeNormal % f1.planeNormal) * f2.planeDist)) / denom;
	}
